...
from app.entities.categories.handlers import *

message_handlers = [process_start, process_first_wallet, process_create_category]

callback_handlers = [show_wallet_menu, wallet_go_back, wallet_create, get_all_wallets_names,
                     process_single_wallet_choose, process_delete_wallet, create_category, show_category_menu,
